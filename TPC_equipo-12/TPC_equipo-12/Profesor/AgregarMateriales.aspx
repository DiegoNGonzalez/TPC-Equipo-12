        ...
        <ContentTemplate>
            <div class="container d-flex justify-content-center align-items-center" style="min-height: 100vh;">
                <div class="card w-50 my-5">
                    <div class="card-body">
                        <asp:Label ID="LabelAgregarMaterial" runat="server" CssClass=" h3 card-title d-flex justify-content-center align-items-center" Text="">Crear Material</asp:Label>
                        <div class="mb-3">
                            <asp:Label ID="LabelNombreMaterial" runat="server" CssClass="form-label" Text=""><b>Nombre</b></asp:Label>
                            <asp:TextBox ID="TextBoxNombreMaterial" runat="server" CssClass="form-control"></asp:TextBox>
                        </div>
                        <div class="mb-3">
                            <asp:Label ID="LabelDescripcionMaterial" runat="server" CssClass="form-label" Text=""><b>Descripción</b></asp:Label>
                            <asp:TextBox ID="TextBoxDescripcionMaterial" runat="server" CssClass="form-control"></asp:TextBox>
                        </div>
                        <div class="mb-3">
                            <asp:Label ID="LabelNumeroMaterial" runat="server" CssClass="form-label" Text=""><b>Número de Material</b></asp:Label>
                            <asp:TextBox ID="TextBoxNumeroMaterial" runat="server" CssClass="form-control" TextMode="Number"></asp:TextBox>
                        </div>
                        <div class="mb-3">
                            <asp:Label ID="LabelTipoMaterial" runat="server" CssClass="form-label" Text=""><b>Tipo de Material</b></asp:Label>
                            ...
                            <div class="mb-3">
                                <asp:Label ID="LabelURLMaterial" runat="server" CssClass="form-label" Text=""><b>URL Archivo</b></asp:Label>
