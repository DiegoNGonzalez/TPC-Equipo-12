                    ...
                    <asp:Repeater ID="rptInscripciones" runat="server">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td>
                                    <asp:Button Text="Aceptar" runat="server" CssClass="btn btn-success" id="btnAceptarInscripcion" OnClick="btnAceptarInscripcion_Click" CommandArgument='<%# Eval("IdInscripcion") %>'/>
