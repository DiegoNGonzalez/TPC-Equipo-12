            ...
            List<Curso> lista = new List<Curso>();
                ...
                try
                {
                    Datos.SetearConsulta(@"
                        SELECT c.IDCurso, c.Nombre, c.Descripcion, c.Estreno, c.Duracion, 
                    ...
                    while (Datos.Lector.Read())
                    {
                        ...
                        aux.Estreno = Datos.Lector.GetDateTime(3);
                        aux.Duracion = Datos.Lector.GetInt32(4);
                        aux.Imagen = new Imagen
                        {
                            IDImagen = Datos.Lector.GetInt32(6),
                            URL = Datos.Lector.GetString(7)
                        };
                        aux.Categoria = new CategoriaCurso
                        {
                            IDCategoria = Datos.Lector.GetInt32(8),
